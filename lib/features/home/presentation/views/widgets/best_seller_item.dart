...
class BestSellerListViewIteams extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.to(()=> const DetailsView(),transition:Transition.circularReveal,duration:const Duration(seconds: 2) );
      },
      child: SizedBox(
        height: 150.h,
        child: Row(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    width: 200.w,
                    child:const Text('Harry Boter and goblet of fire',style: AppStyle.textStyle20Normal,maxLines: 2,overflow:TextOverflow.ellipsis ,),),
                     SizedBox(height: 3.h,),
                    Text('J.K  rowiling',style: AppStyle.textStyle14Normal.copyWith(color:const Color.fromARGB(255, 236, 223, 223))),
                   Row(children: [
